...
void Application::setOptimizationData(const float * data) {
    ...
    */
    ...
    PDController** PDcontrol = m_biped->getPDControllers();
    PDcontrol[0]->setGains(data[0],data[1]);
    PDcontrol[1]->setGains(data[2],data[3]);
    PDcontrol[2]->setGains(data[4],data[5]);
    PDcontrol[3]->setGains(data[6],data[7]);
    PDcontrol[4]->setGains(data[8],data[9]);
    PDcontrol[5]->setGains(data[10],data[11]);
    PDcontrol[5]->setGains(data[12],data[13]);
}
